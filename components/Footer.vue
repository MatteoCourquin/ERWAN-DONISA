<template>
  <footer class="footer bg-black relative">
    ...
    <div class="flex justify-between">
      <div>
        <h6 class="pb-3 text-white !capitalize">Version</h6>
